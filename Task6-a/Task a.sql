...
SELECT COUNT(name) FROM movies 
																						JOIN movies_directors ON movies.id=movies_directors.movie_id 																				JOIN directors ON directors.id=movies_directors.director_id 
																						WHERE directors.first_name="Clint" AND directors.last_name="Eastwood";
SELECT name FROM movies 
																						JOIN movies_directors ON movies.id=movies_directors.movie_i																				JOIN directors ON directors.id=movies_directors.director_id 
																						WHERE directors.first_name="Clint" AND directors.last_name="Eastwood";
SELECT first_name, last_name FROM directors 
